    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700 focus:border-primary-500 focus:outline-none pr-12 ${error ? 'border-error' : ''} ${className}`}
          {...props}
        />
        <button
          type="button"
